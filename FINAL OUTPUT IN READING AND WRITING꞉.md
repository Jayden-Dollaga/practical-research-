 ...
 * Sample (Provide a sample of the assigned academic text.)
Formatting Requirements:
 * Size: Long Bondpaper (8.5 x 13 in)
 * Font: Calibri
 * Font size: 11
 * Alignment: Justified
...
| REPORTERS                    | TOPIC                             |
| ---------------------------- | --------------------------------- |
| ABAD, RIVERA                 | BOOK REVIEW OR ARTICLE CRITIQUE   |
| CABONEGRO, ROLLON, SUSANA    | LITERATURE REVIEW                 |
| CACAYURAN, TOBIAS            | RESEARCH REPORT                   |
| **DOLLAGA, CANATOY**         | **PROJECT PROPOSAL**              |
| EGUANA, ELEPONGA             | POSITION PAPER                    |
| FRANCISCO, GUMAHAD           | RESUME VS CURRICULUM VITAE        |
| GARCIA, HERNANDEZ, SUMACATON | APPLICATION FOR COLLEGE ADMISSION |
| INOCENTES, PALERO            | APPLICATION FOR EMPLOYMENT        |
| DANIEL, SARIA, URBANO        | FORMS OF OFFICE CORRESPONDENCE    |
